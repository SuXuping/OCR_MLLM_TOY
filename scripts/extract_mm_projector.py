...
def parse_args():
    ...
    parser.add_argument('--model-path', type=str, default='./checkpoints/qwen14b-finetune_all/checkpoint-8300',help='model folder')
    parser.add_argument('--output', type=str, default='./checkpoints/qwen14b-finetune_all/checkpoint-8300/mm_projector.bin', help='output file')
